...
attr LD2450_Bridge_Control webCmd start:stop:status

Jetzt kommt das “Device” zum Starten
bdefmod LD2450_Script_Action_Start notify LD2450_Bridge_Control:start\
{\
  \
...
\
  # Der Kommando-String:\
  # 1. Startet das Skript im Hintergrund\
  # 2. Leitet die Ausgabe in eine Log-Datei um (nohup)\
  # 3. Speichert die PID in eine Datei\
...
\
  ...
  Log 3, "LD2450 Script: NICHT-blockierend gestartet. PID: $pid";;\
}
attr LD2450_Script_Action_Start room Radar

Und das Device zum Stoppen
defmod LD2450_Script_Action_Stop notify LD2450_Bridge_Control:stop\
{\
...
Grundsätzlich läuft jetzt schon alles und nach dem Starten sollte das FHEM device “LD2450_Radar_1” schon die Werte anzeigen. (Falls die Werte gespiegelt sind bitte am Anfang die Hinweise beachten)
...
Da meine Perl und Python Kenntnisse eher rudimentär sind wollte ich dieses Projekt mit Hilfe der KI erstellen.
Grundsätzlich hat mir das geholfen aber je mehr das Projekt gewachsen ist umso mehr “Fehler” machte die KI.
Sorry wenn hier Schreibfehler sind oder sonstige Fehler im Code.
Ich komme noch aus einem Baujahr wo es das Wort Mobbing noch nicht gab oder unter Strafe stand.
Also habe ich gelernt mit Kritik fast jeder Art umzugehen.
...
https://github.com/MontiCliff/FHEM-LD2450-Radar.git
